...
A starter Java 21 command-line tool scaffolded with Gradle for encrypting and decrypting archives.

## Features
- Java 21 project configured with the Gradle (Groovy) build tool.
